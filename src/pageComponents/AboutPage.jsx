    ...
    return (
        <main>
            <div className="page-top card">
                ...
                <img className="border-4 border-(--detail-color-2) rounded-xl about-image" loading="lazy" src={meIMG} alt="Ellena pictured in a brightly-lit area and she is smiling. She is a thin girl with shoulder-length brown hair, gray eyes, and glasses."/>
            </div>
