function Skills() {
  return (
    <section
      id="skills"
      className="section-padding flex flex-col justify-between gap-10 bg-(--background-color-2) lg:flex-row lg:items-start lg:gap-20"
    >
        ...
        <div className="flex flex-col justify-between gap-10 md:flex-row">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <p className="skill-pill">BootStrap</p>
            </div>
          </div>
          <div className="flex flex-col gap-4">
