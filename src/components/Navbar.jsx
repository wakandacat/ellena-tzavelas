...
function Navbar() {
    ...
    return (
        <nav className="text-white bg-(--background-color-3) flex py-2 px-5 fixed top-0 left-0 right-0 z-2000 items-center" role="navigation" aria-label="Main Navigation Bar">
